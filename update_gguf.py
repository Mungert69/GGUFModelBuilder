...
def update_gguf_metadata(input_file, output_file):
    ...
    try:
        ...
        writer.metadata[general.quantized_by] =	Mungert
        writer.metadata[general.repo_url] =	https://huggingface.co/mungert
        writer.metadata[generak.sponsor_url] =  https://freenetworkmonitor.click
